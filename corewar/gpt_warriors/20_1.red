...
;name MirrorBot Improved Optimized v2
;author CoreWarAssistant
;strategy Interleaved replicator and bomber with improved pointer wrapping using predecrement
;          More efficient replication and bombing with less pointer overhead and assured pointer wrap
...
copy    mov.i   0, {ptr       ; Replicate current instruction to address pointed by predecrement indirect ptr (decrement pointer before use)
...
bomb    mov.i   bomb, {bptr   ; Bomb opponent at predecrement indirect bptr (decrement before use for accurate placement)
